...
LIBPATH_ST = '-L%s'
LIB_OPENCV = ['opencv_core', 'opencv_imgproc', 'opencv_highgui', 'opencv_ml', 'opencv_video', 'opencv_features2d', 'opencv_calib3d', 'opencv_objdetect', 'opencv_contrib', 'opencv_legacy', 'opencv_flann']
LIB_ST = '-l%s'
